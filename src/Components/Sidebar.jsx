...
function Sidebar() {
    ...
    return (
        <aside className="w-72 bg-gray-100 fixed left-0 top-14 bottom-0 shadow-[6px_0_12px_-2px_rgba(0,0,0,0.15)] overflow-hidden">
            <div className="max-h-[calc(100vh-3.5rem)] overflow-y-auto custom-scroll">
                <div className="w-full p-4 shadow-[4px_0_6px_-2px_rgba(0,0,0,0.1),_-4px_0_6px_-2px_rgba(0,0,0,0.1)]">
                    <div className="">
                    ...
                    <div className="">
                        <p className="mb-2 text-gray-700">Find the perfect career guidance</p>
                        <Formik
                        ...
                        <div className=" flex flex-col gap-2">
                            ...
                            <ul className="list-none p-0">
                                <li>
                                    <Link to="/courses-adse" className="text-blue-600">
                                        ACCP-AI
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/placement" className="text-blue-600">
                                        Placement
                                    </Link>
                                </li>
                                <li>
                    ...
                    <div className="mt-6 space-y-2 text-sm">
                        ...
                        <p>
                            <a href="tel:+9221111278324" className="flex items-center gap-2">
                                <FiPhone className="text-lg" />
                                <span>(+92) 21-111 278 324</span>
                            </a>
                        </p>
                        <h5 className="font-semibold">
                            Aptech Learning Pakistan, Franchise Support Pakistan.
                        </h5>
                        <p>
                            Suite # 213, 2nd Floor, Progressive Center, PECHS Block 6, Main
                            Shahrah-e-Faisal, Karachi, Pakistan. PO-Box: 75400
                        </p>
                    </div>
                </div>
            </div>
