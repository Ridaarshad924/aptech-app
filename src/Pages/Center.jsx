                        ...
                        <section className="citiesFilter">
                            {isSmallDevice ? (
                                <menu className="menutab"
                                    ...
                                    {/* Upcoming Batch */}
                                    <button className={`menu__item ${activeTab === "Batch" ? "active" : ""}`}
                                        ...
                                        <p style={{ fontSize: "8px" }}>Upcoming Batch</p>
                                    </button>

                                    {/* Student of the Month */}
                                    <button className={`menu__item ${activeTab === "Student" ? "active" : ""}`}
                                        style={{ height: "1px", width: "39px" }}
                                        ...
                                        <p style={{ fontSize: "8px" }}>Student of the Month</p>
                                    </button>

                                    {/* Project of the Month */}
                                    <button className={`menu__item ${activeTab === "Project" ? "active" : ""}`}
                                        style={{ height: "1px", width: "39px" }}
                                        ...
                                        <p style={{ fontSize: "8px" }}>Project of the Month</p>
                                    </button>

                                    {/* Placement */}
                                    <buttonn className={`menu__item ${activeTab === "Placement" ? "active" : ""}`}
                                        style={{ height: "1px", width: "39px" }}
                                        ...
                                        <p style={{ fontSize: "8px" }}>Placement</p>
                                    </buttonn>

                                    {/* Event */}
                                    <button className={`menu__item ${activeTab === "Event" ? "active" : ""}`}
                                        style={{ height: "1px", width: "39px" }}
                                ...
                                <menu className="menutab menutab2">
                                    ...
                                    {/* Placement */}
                                    <button className={`menu__item ${activeTab === "Placement" ? "active" : ""}`}
                                        onClick={() => setActiveTab("Placement")}
                                    >
                                        <svg
                                            className="icon"
                                                                                ...
                                                                                e?.courseName === "ACCP"
                                                                                    ...
                                                                                    : e?.courseName === "DM"
                                                                                        ...
                                                                                        : e?.courseName === "ENG"
                                                                                            ...
                                                                                            : "" // add other courses as before
                                                                            }
                                                                            alt={e?.courseName}
                                                                            className="w-[60px] mx-auto object-contain"
                                                                        />
                                                                    </td>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <td className="text-center py-3 px-4">
                                                                            <div className="w-16 h-16 mx-auto rounded-full bg-yellow-50 flex items-center justify-center shadow-sm">
                                                                                <img
                                                                                    src={e?.courseName === "ACCP" ? "assets/images/ACCPAI/ACCP-AI-01.png" : ""}
                                                                                    alt={e?.courseName}
